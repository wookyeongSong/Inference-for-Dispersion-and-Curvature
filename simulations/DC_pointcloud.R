...
par(mar=c(5,5,3,2))
plot(ellipse(cov.est.pc.pos,center = c(Vm.est.pc.pos,Vf.est.pc.pos),level=0.99),type='l',col=col[1],xlim = c(1.6,2.6), ylim =c(1.6,2.6) ,lwd=2,xlab=expression(V[M]), ylab = expression(V[F]),cex.main=2.5,cex.lab=2,cex.axis=2,main="Point cloud data on spherical manifold")
...
par(mar=c(5,5,3,2))
plot(ellipse(cov.est.pc.neg,center = c(Vm.est.pc.neg,Vf.est.pc.neg),level=0.99),type='l',col=col[1],xlim = c(5,8), ylim =c(5,8),lwd=2,xlab=expression(V[M]), ylab = expression(V[F]),cex.main=2.5,cex.lab=2,cex.axis=2,main="Point cloud data on hyperbolic manifold")
...
par(mar=c(5,5,3,2))
plot(ellipse(cov.est.pc.flat,center = c(Vm.est.pc.flat,Vf.est.pc.flat),level=0.99),type='l',col=col[1],xlim = c(0.4,0.65), ylim =c(0.4,0.65),lwd=2,xlab=expression(V[M]), ylab = expression(V[F]),cex.main=2.5,cex.lab=2,cex.axis=2,main="Point cloud data on flat manifold")
